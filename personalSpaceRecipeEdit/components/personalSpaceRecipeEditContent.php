...
if (isset($recipes) && !empty($recipes)) { ?>
    ...
    <div class="container mb-3 mt-2">
        ...
        <form action="/PROJET%20PERSO/personalSpaceRecipeFormEdit/personalSpaceRecipeFormEdit.php" method="POST">

            <legend>Modifier votre recette</legend>

            <div class="form-group">
                <label for="title" class="form-label mt-2">Titre de votre recette :</label>
                <input class="form-control" name="title" type="text" id="title" value="<?php echo $recipes[0]['title'] ?>">
            </div>

            <div class="form-group">
                <label for="persons" class="form-label mt-2">Nombre de personnes :</label>
                <input class="form-control" name="persons" type="number" id="persons" min="1" max="20" value="<?php echo $recipes[0]['persons'] ?>">
            </div>
