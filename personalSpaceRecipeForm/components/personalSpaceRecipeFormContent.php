    ...
    ?>
        <div class="container mt-3 text-center">
            ...
            <div class="button">
                ...
                <a href="/PROJET%20PERSO/personalSpaceRecipeCreation/personalSpaceRecipeCreation.php"><button type="button" class="btn btn-primary">Retour au formulaire</button></a>
            </div>
