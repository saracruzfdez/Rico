...
?>
        ...
        <div class="container mt-3 text-center">
            <div class="button">
                ...
                <a href="/PROJET%20PERSO/accountFiles/account/account.php"><button type="button" class="btn btn-primary">Voir compte</button></a>
            </div>
        </div>
    ...
    ?>
        ...
        <div class="container mt-3 text-center">
            ...
            <div class="button">
                ...
                <a href="/PROJET%20PERSO/accountFiles/accountCreation/accountCreation.php"><button type="button" class="btn btn-primary">Retour au formulaire</button></a>
            </div>
