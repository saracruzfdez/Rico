...
<div class="card mb-3">
    ...
    <a href="/PROJET%20PERSO/personalSpaceRecipeDetail/personalSpaceRecipeDetail.php?id=<?php echo ($recipe['id']); ?>"><img class="image-card" src="<?php echo $recipe['image']; ?>" alt="" width="100%" height="100%"></a>
    ...
    <div class="card-body">
        ...
        <a href="/PROJET%20PERSO/personalSpaceRecipeDetail/personalSpaceRecipeDetail.php?id=<?php echo ($recipe['id']); ?>" class="btn btn-primary">Voir la recette</a>
    </div>
