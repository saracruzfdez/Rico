...
?>
    ...
    <div class="container mt-3">
        ...
        <div class="mt-3">
            ...
            <div class="button">
                <a href="/PROJET%20PERSO/personalSpaceRecipeEdit/personalSpaceRecipeEdit.php?id=<?php echo ($recipes[0]['id']); ?>"><button type="button" class="btn btn-primary">Editer recette</button></a>
            </div>

            <div class="button">
                <a href="/PROJET%20PERSO/personalSpaceRecipeDelete/personalSpaceRecipeDelete.php?id=<?php echo ($recipes[0]['id']); ?>"><button type="button" class="btn btn-primary">Supprimer recette</button></a>
            </div>
