...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <a href="/PROJET%20PERSO/categories/categoriesView/categoriesView.php?id=<?php echo ($category['id']); ?>" class="btn btn-outline-primary mt-3"><?php echo ($category['name']); ?></a>
